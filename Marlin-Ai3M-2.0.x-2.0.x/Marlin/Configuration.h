...
#define STRING_CONFIG_H_AUTHOR "(sergio)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // i3 Mega stock v5 hotend, 40W heater cartridge (3.6Ω @ 22°C) I MODIFIED IT, IT DOES NOT USED TO WORK SO WELL
  ...
  230°, FAN ON: <M303 E0 C8 S230>
  Recv: #define DEFAULT_Kp 26.93
  Recv: #define DEFAULT_Ki 2.22
  Recv: #define DEFAULT_Kd 81.61
  &&
  Recv: #define DEFAULT_Kp 10.38
  Recv: #define DEFAULT_Ki 0.51
  Recv: #define DEFAULT_Kd 52.72
  &&
  Recv: #define DEFAULT_Kp 14.61
  Recv: #define DEFAULT_Ki 0.88
  Recv: #define DEFAULT_Kd 60.44
  
  230°, FAN ON: <M303 E0 C20 S230>
  Recv: #define DEFAULT_Kp 13.37
  Recv: #define DEFAULT_Ki 0.70
  Recv: #define DEFAULT_Kd 63.51
  

  210°, FAN ON: <M303 E0 C8 S210>
  Recv: #define DEFAULT_Kp 14.84
  Recv: #define DEFAULT_Ki 0.90
  Recv: #define DEFAULT_Kd 61.37

  230°: <M303 E0 C8 S230>
  Recv: #define DEFAULT_Kp 15.88
  Recv: #define DEFAULT_Ki 0.94
  Recv: #define DEFAULT_Kd 66.99

  210°: <M303 E0 C8 S210>
  Recv: #define DEFAULT_Kp 15.88
  Recv: #define DEFAULT_Ki 0.95
  Recv: #define DEFAULT_Kd 66.69
  */
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Anycubic i3 Mega Ultrabase (0.9Ω @ 22°C) MODIFIED
